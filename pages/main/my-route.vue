  ...
  <main class="container mx-auto my-6">
    <div style="border: 1px red solid">
      <div class="flex gap-5" style="border: 1px blue solid">
        <div style="border: 1px orange solid" class="py-4 px-5">
          ...
          <div class="pt-2">
            <div>
              ...
              <input type="text" v-model="searchCriteria" class="text-input w-full" />
            </div>
            <div class="flex justify-end py-2">
              <button class="border border-slate-300 rounded-md p-1"><font-awesome-icon :icon="['fas', 'angle-left']"
                  size="xl" /></button>
              <button class="border border-slate-300 rounded-md ml-2 p-1"><font-awesome-icon :icon="['fas', 'angle-right']"
                  size="xl" /></button>
            </div>
        ...
        <div style="border: 1px #ff4500 solid" class="grow p-4">
          <div>
            <h1 class="font-bold text-3xl">Mi ruta</h1>
          </div>
          <div class="courses-season-panel flex p-3">
            <CoursesSeasonCard />
            <CoursesSeasonCard />
          </div>
        </div>
      ...
      <div class="mt-4 p-5" style="border: 1px purple solid">
        <div>
          <h1 class="font-bold text-2xl">Visualización de cursos</h1>
          <hr />
          <p>Si quieres saber mejor cuál curso seleccionar, dale clic al curso del cual deseas consultar su información
          </p>
        </div>
